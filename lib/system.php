<?php
  ...
  else if(ACTION == "installSite")
  {
    ...
    if($siteInstalled > 0)
    {
      ...
      file_put_contents('config.php', $currentConfig . '  define("secret2FA", "'. $secretAuth .'");');
      unlink('../install.html');
    }
    else {
